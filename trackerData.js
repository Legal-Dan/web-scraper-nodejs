function trackerData() {
    return [
        ...
        },
        {
            ...
            identifier: 'Softcover, Premium Color Book (8.5" x 11")</p><!----></div><div _ngcontent-serverapp-c129="" class="col-6 col-md-3 product-tile-book-size"></div><div _ngcontent-serverapp-c129="" class="col col-md-3 u-text-right"><!----><!----><p _ngcontent-serverapp-c129="" class="is-inline product-tile-text-highlight cy-prc"> '
        },
        {
            ...
            identifier: 'Softcover, Standard Color Book (8.5" x 11")</p><!----></div><div _ngcontent-serverapp-c129="" class="col-6 col-md-3 product-tile-book-size"></div><div _ngcontent-serverapp-c129="" class="col col-md-3 u-text-right"><!----><!----><p _ngcontent-serverapp-c129="" class="is-inline product-tile-text-highlight cy-prc"> '
        }
    ]
}
